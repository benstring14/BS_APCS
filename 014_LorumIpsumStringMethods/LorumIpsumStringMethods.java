public class LorumIpsumStringMethods
{
    ...
    {
        //Here I learned how to use string methods
        ...
        int length = lorumIpsum.length();
        System.out.println(length);
        //Used this to find length of string in an int
        String trim = lorumIpsum.trim();
        //Trimmed off spaces
        int trimmedLength = trim.length();
        System.out.println(trimmedLength);
        String upperCase = trim.toUpperCase();
        System.out.println(upperCase);
        String lowerCase = trim.toLowerCase();
        System.out.println(lowerCase);
        boolean foo = trim.equals("goat");
        //boolean to see whether the string is equal to said input
        System.out.println(foo);
        boolean doo = trim.equals(lorumIpsum);
        System.out.println(doo);
        boolean poo = trim.equals(trim);
        System.out.println(poo);
        int crew = trim.indexOf("q");
        System.out.println(crew);
        int stoo = trim.indexOf("nullam");
        //shows where in the string u can find this
        System.out.println(stoo);
        String poop = trim.replace('o','x');
        System.out.println(poop);
        boolean stinky = trim.contains("z");
